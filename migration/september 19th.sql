...
ALTER TABLE gisedu_integer_field ADD COLUMN polygon_id integer;
ALTER TABLE gisedu_char_field ADD COLUMN polygon_id integer;
ALTER TABLE gisedu_boolean_field ADD COLUMN polygon_id integer;

INSERT INTO gisedu_polygon_item (filter_id, item_name, the_geom) SELECT filter_id, name, the_geom FROM ohio_counties;
INSERT INTO gisedu_integer_field (polygon_id, field_value) SELECT id, fips_num FROM gisedu_polygon_item JOIN ohio_counties ON (gisedu_polygon_item.item_name = ohio_counties.name);
UPDATE gisedu_integer_field SET field_name = 'fips_number' WHERE field_name is null;
INSERT INTO gisedu_integer_field (polygon_id, field_value) SELECT id, cnty_num FROM gisedu_polygon_item JOIN ohio_counties ON (gisedu_polygon_item.item_name = ohio_counties.name);
UPDATE gisedu_integer_field SET field_name = 'county_number' WHERE field_name is null;
INSERT INTO gisedu_char_field (polygon_id, field_value) SELECT id, abbrev FROM gisedu_polygon_item JOIN ohio_counties ON (gisedu_polygon_item.item_name = ohio_counties.name);
UPDATE gisedu_char_field SET field_name = 'county_abbreviation' WHERE field_name is null;
...
INSERT INTO gisedu_char_field (polygon_id, field_value) SELECT gisedu_polygon_item.id, beg_grade FROM gisedu_polygon_item JOIN ohio_school_districts ON (gisedu_polygon_item.item_name = ohio_school_districts.name);
UPDATE gisedu_char_field SET field_name = 'beg_grade' WHERE field_name is null;
INSERT INTO gisedu_char_field (polygon_id, field_value) SElECT gisedu_polygon_item.id, end_grade FROM gisedu_polygon_item JOIN ohio_school_districts ON (gisedu_polygon_item.item_name = ohio_school_districts.name);
UPDATE gisedu_char_field SET field_name = 'end_grade' WHERE field_name is null;
INSERT INTO gisedu_char_field (polygon_id, field_value) SElECT gisedu_polygon_item.id, taxid FROM gisedu_polygon_item JOIN ohio_school_districts ON (gisedu_polygon_item.item_name = ohio_school_districts.name);
UPDATE gisedu_char_field SET field_name = 'taxid' WHERE field_name is null;
INSERT INTO gisedu_integer_field (polygon_id, field_value) SElECT gisedu_polygon_item.id, district_irn FROM gisedu_polygon_item JOIN ohio_school_districts ON (gisedu_polygon_item.item_name = ohio_school_districts.name);
UPDATE gisedu_integer_field SET field_name = 'district_irn' WHERE field_name is null;
INSERT INTO gisedu_boolean_field (polygon_id, field_value) SElECT gisedu_polygon_item.id, comcast_coverage FROM gisedu_polygon_item JOIN ohio_school_districts ON (gisedu_polygon_item.item_name = ohio_school_districts.name);
UPDATE gisedu_boolean_field SET field_name = 'comcast_coverage' WHERE field_name is null;
INSERT INTO gisedu_boolean_field (polygon_id, field_value) SElECT gisedu_polygon_item.id, has_atomic_learning FROM gisedu_polygon_item JOIN ohio_school_districts ON (gisedu_polygon_item.item_name = ohio_school_districts.name);
...
INSERT INTO gisedu_polygon_item_integer_field (polygon_id, field_id) SELECT polygon_id, id FROM gisedu_integer_field;
INSERT INTO gisedu_polygon_item_char_field (polygon_id, field_id) SELECT polygon_id, id FROM gisedu_char_field;
INSERT INTO gisedu_polygon_item_boolean_field (polygon_id, field_id) SELECT polygon_id, id FROM gisedu_boolean_field;

ALTER TABLE gisedu_integer_field DROP COLUMN polygon_id;
ALTER TABLE gisedu_char_field DROP COLUMN polygon_id;
ALTER TABLE gisedu_boolean_field DROP COLUMN polygon_id;
...
ALTER TABLE gisedu_integer_field ADD COLUMN point_id integer;
ALTER TABLE gisedu_char_field ADD COLUMN point_id integer;
ALTER TABLE gisedu_boolean_field ADD COLUMN point_id integer;
...
INSERT INTO gisedu_integer_field (point_id, field_value) SELECT gisedu_point_item.id, building_irn 
...
INSERT INTO gisedu_integer_field (point_id, field_value) SELECT gisedu_point_item.id, mbit 
	FROM gisedu_point_item JOIN gisedu_school ON (gisedu_point_item.school_id = gisedu_school.gid)
	JOIN gisedu_school_info ON gisedu_school.building_info_id = gisedu_school_info.gid;
UPDATE gisedu_integer_field SET field_name = 'school_connectivity' WHERE field_name is null;

INSERT INTO gisedu_char_field (point_id, field_value) SELECT gisedu_point_item.id, classification 
	FROM gisedu_point_item JOIN gisedu_school ON (gisedu_point_item.school_id = gisedu_school.gid)
	JOIN gisedu_school_info ON gisedu_school.building_info_id = gisedu_school_info.gid
	JOIN school_area_classification ON gisedu_school_info.area_class_id = school_area_classification.gid;
UPDATE gisedu_char_field SET field_name = 'school_classification' WHERE field_name is null;

INSERT INTO gisedu_char_field (point_id, field_value) SELECT gisedu_point_item.id, itc 
	FROM gisedu_point_item JOIN gisedu_school ON (gisedu_point_item.school_id = gisedu_school.gid)
	JOIN gisedu_school_info ON gisedu_school.building_info_id = gisedu_school_info.gid
	JOIN school_itc ON gisedu_school_info.itc_id = school_itc.gid;
UPDATE gisedu_char_field SET field_name = 'school_itc' WHERE field_name is null;

INSERT INTO gisedu_char_field (point_id, field_value) SELECT gisedu_point_item.id, grade_name 
...
UPDATE gisedu_char_field SET field_name = 'school_grade' WHERE field_name is null;
...
INSERT INTO gisedu_point_item_integer_field (point_id, field_id) SELECT point_id, id FROM gisedu_integer_field WHERE point_id is not null;
INSERT INTO gisedu_point_item_char_field (point_id, field_id) SELECT point_id, id FROM gisedu_char_field WHERE point_id is not null;
INSERT INTO gisedu_point_item_boolean_field (point_id, field_id) SELECT point_id, id FROM gisedu_boolean_field WHERE point_id is not null;

ALTER TABLE gisedu_integer_field DROP COLUMN point_id;
ALTER TABLE gisedu_char_field DROP COLUMN point_id;
ALTER TABLE gisedu_boolean_field DROP COLUMN point_id;
...
DROP TABLE gisedu_joint_vocational_school_district;
*/